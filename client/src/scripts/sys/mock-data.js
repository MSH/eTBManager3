...
export function generateName() {
	...
	const name = (gender === 'MALE' ? firstNamesMale[randonIndex(firstNamesMale.length)] : firstNamesFemale[randonIndex(firstNamesFemale.length)]) + ' ' + lastNames[randonIndex(lastNames.length)];
...
const mockTreatment = {
	...
	units: [
		...
		},
		{
			unit: {
				id: '12313123-2',
				name: 'Centro de Referência Professor Hélio Fraga'
			},
			ini: '2015-05-02',
			end: '2016-12-31'
		}
...
export { mockTbCase, mockTreatment };
...
const firstNamesMale = ['Airton', 'Augusto', 'Abu', 'Abdul', 'Albert', 'Antony', 'Anderson', 'Arnaldo', 'Andre', 'Alan', 'Alexandre', 'Alex', 'Aleksey', 'Arin', 'Arnauld', 'Agnaldo', 'Albert', 'Alberto', 'Abaeté', 'Abdão', 'Abdias', 'Abel', 'Ademar', 'Barnabas', 'Barnaby', 'Barton', 'Bernard', 'Bevis', 'Bond', 'Booth', 'Brick', 'Brier', 'Brigham', 'Brinley', 'Baltasar', 'Baren', 'Beto', 'Benedito', 'Bernardo', 'Benjamin', 'Becan', 'Bruno', 'Brandon', 'Biafra', 'Baltazar', 'Bartolomeu', 'Batista', 'Belisario', 'Benjamin', 'Bonifácio', 'Bruce', 'Carter', 'Cecil', 'Cedric', 'Charles', 'Chick', 'Chilton', 'Chip', 'Christian', 'Christopher', 'Cicero', 'Cláudio', 'Clenildo', 'Carlos', 'Caetano', 'Clayton', 'Claude', 'Conrado', 'Constantino', 'Constantin', 'Caio', 'Clarence', 'Clay', 'Clayland', 'Clayton', 'Cleave', 'Clem', 'Clemens', 'Clement', 'Cliff', 'Clifford', 'Clint', 'Clinton', 'Dado', 'Daniel', 'Dilson', 'David', 'Dean', 'Dean', 'Diamond', 'Dixon', 'Duff', 'Ebenezer', 'Edgar', 'Edward', 'Edwin', 'Eliah', 'Eliezer', 'Iuri', 'Yuri', 'Jean', 'Mohamed', 'Nuno', 'Norberto', 'Nilo', 'Nicholas', 'Noel', 'Osmar', 'Oswald', 'Paulo', 'Pedro', 'Peter', 'Paul', 'Phillip', 'Patrick', 'Raymond', 'Ricardo', 'Roosevelt', 'Rennan', 'Renato', 'Raul', 'Ramon', 'Rachid', 'Ringo', 'Sergey', 'Samuel', 'Sandro', 'Silvester', 'Steffano', 'Steve', 'Will', 'Xavier'];

const firstNamesFemale = ['Alynn', 'Abbey', 'Aaron', 'Abbie', 'Abbigail', 'Abby', 'Abigail', 'Abigayle', 'Abilene', 'Abiranna', 'Ada', 'Adabel', 'Addison', 'Addsyn', 'Adela', 'Albertina', 'Agnes', 'Andreia', 'Angela', 'Arinan', 'Ana Maria', 'Ana Lúcia', 'Ana', 'Ameely', 'Alice', 'Aline', 'Arminda', 'Benedita', 'Bruna', 'Beatriz', 'Barbara', 'Bianca', 'Berenice', 'Bruna', 'Clara', 'Célia', 'Carolina', 'Carol', 'Carla', 'Clarice', 'Daniele', 'Diana', 'Débora', 'Emily', 'Esmeralda', 'Elisabeth', 'Flávia', 'Fátima', 'Fabiana', 'Fernanda', 'Gilda', 'Helena', 'Iraci', 'Iná', 'Jocilaine', 'Maria', 'Maria Antônia', 'Manoela', 'Michele', 'Mel', 'Melissa', 'Nair', 'Karla', 'Keli', 'Kimberly', 'Keila', 'Lara', 'Laura', 'Margareth', 'Mabel', 'Madaline', 'Madelene', 'Madeline', 'Madelyn', 'Nataly', 'Noelma', 'Otaviana', 'Paula', 'Patrícia', 'Paloma', 'Paris', 'Regina', 'Roberta', 'Rogéria', 'Raquel', 'Rebeca', 'Raimunda', 'Romana', 'Rose', 'RaDonna', 'Rae', 'Raechel', 'Sylvia', 'Sara', 'Telma', 'Tara', 'Uma', 'Vada', 'Val', 'Valarie', 'Velma', 'Valéria', 'Velma', 'Vanity', 'Velia', 'Velma', 'Quilma', 'Qbilah', 'Queen', 'Queena', 'Queenie', 'Quentina', 'Quiana', 'Quinn', 'Karen', 'Kelly'];

const lastNames = ['Antunes', 'Abbott', 'Adamczyk', 'Agnaudo', 'Araujo', 'Apple', 'da Silva', 'Debrieux', 'Batista', 'Bolivar', 'Brasil', 'Bottino', 'Blue', 'Bachman', 'Bailey', 'Brick', 'Dianno', 'DAvona', 'Dmarco', 'Da neen', 'Da wan', 'Daava', 'Dafne', 'Dagian', 'Dahlia', 'Daija', 'Dantas', 'Dickinson', 'da Costa', 'Copala', 'Cortez', 'Costeau', 'da Costa Saldanha', 'Caliva', 'Callaghan', 'Dutra', 'Boon', 'Bernardes', 'Busht', 'Dabrowski', 'Daecher', 'Edwards', 'Eisenhower', 'Ford', 'Farias', 'Fernandes', 'Fernandez', 'Forest', 'Fancher', 'Fantauzzo', 'Gallet', 'Gomes', 'Gump', 'Greenhill', 'Greece', 'Green', 'Gray', 'Garcia', 'Gusmão', 'Gabriell', 'Gao', 'Gardenia', 'Galena', 'Gallo', 'Garcia', 'Hahn', 'Haley', 'Himan', 'Hill', 'Hutson', 'Highway', 'Julia', 'Jordan', 'Jackson', 'Johnson', 'Silveira'];
