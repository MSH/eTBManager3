 ...
 */
@Service
public class ExamDSTServiceImpl extends CaseEntityServiceImpl<ExamDST, EntityQueryParams> implements ExamDSTService {

    @Override
    public String getCommandType() {
        return CommandTypes.CASES_CASE_EXAM_DST;
    }
