...
/**
 * Default implementation of the {@link IndicatorRow} interface for {@link DataTableIndicator}
 *
 * Created by rmemoria on 10/9/16.
 */
public class IndicatorRowImpl extends RowImpl implements IndicatorRow {
    ...
    /**
     * Default constructor
     * @param dataTable the instance of {@link DataTableImpl} this row belongs to
     */
    public IndicatorRowImpl(DataTableImpl dataTable) {
        super(dataTable);
    }
    ...
    protected void addChildRow(IndicatorRow row) {
        ...
        rows.add(row);
        ((IndicatorRowImpl)row).setParent(this);
    }
